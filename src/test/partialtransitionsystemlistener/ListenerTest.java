...
public class ListenerTest extends TestJPF {
     ...
     * the target class).
     */
    private static String labelFileName = ListenerTest.class.getName() + ".lab";

    /**
     * The name of the graph file (i.e. the default file name is the signature of
     * the target class).
     */
    private static String dottyFileName = ListenerTest.class.getName() + ".dot";
    ...
    public static void tearDownAfterClass() {
        ...
        File legendFile = new File(ListenerTest.class.getName() + "_legend.dot");
        legendFile.delete();
    }
